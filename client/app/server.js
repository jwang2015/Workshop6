 ...
 */
export function postComment(feedItem, author, contents, cb) {
  sendXHR('POST', '/feeditem/' + feedItem + '/commentthread/comment', {
     author: author,
     contents: contents
   }, (xhr) => {
     cb(JSON.parse(xhr.responseText));
 ...
 */
 export function likeComment(feedItemId, commentId, userId, cb) {
    sendXHR('PUT', '/feeditem/' + feedItemId + '/commentthread/comment/' + commentId + '/likelist/' + userId,
    undefined, (xhr) => {
      cb(JSON.parse(xhr.responseText));
    });
  }
 ...
 */
 export function unlikeComment(feedItemId, commentId, userId, cb) {
    sendXHR('DELETE', '/feeditem/' + feedItemId + '/commentthread/comment/' + commentId + '/likelist/' + userId,
    undefined, (xhr) => {
      cb(JSON.parse(xhr.responseText));
    });
}
